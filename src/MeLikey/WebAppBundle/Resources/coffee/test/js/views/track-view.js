...
define(['models/track', 'views/base/view', 'views/player-controls-view', 'views/seekbar-view', 'templates/track-full', 'facebookSDK'], function(Track, View, PlayerControlsView, SeekbarView, template, FB) {
  'use strict';
  var TrackView, _ref;
